...
# duplicated from update-homebrew-template.yml so it can run standalone.
# If you change formula generation here, update the workflow template too
# (and vice versa). See "Keeping the test script in sync" in README.md.
#
# Usage:
